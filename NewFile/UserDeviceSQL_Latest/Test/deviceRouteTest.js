...
describe('Routes Testing', function(){
    it('Test case1-->Should fetch the records of device with the defined property',(done)=>{
    ...
    it('should insert the device record successfully with appropriate parameter',(done)=>{
        chai.request(serverLocalHost)
        .post('/device')
        .send({
    ...
    it('should not insert the device record successfully with inappropriate parameter',(done)=>{
        chai.request(serverLocalHost)
        .post('/device')
        .send({
            NAME_COL:DEVICE_NAME
    ...
    it('should update the device record successfully',(done)=>{
        chai.request(serverLocalHost)
        .put('/device')
        .send({
            NAME_COL:DEVICE_NAME,
    ...
    it('should not update the device record successfully',(done)=>{
        chai.request(serverLocalHost)
        .put('/device')
        .send({
            NAME_COL:DEVICE_NAME,
    ...
    it('should delete the device record',(done)=>{
        chai.request(serverLocalHost)
        .delete('/device')
        .send({
            ID:"3"
    ...
    it('should not delete the device record',(done)=>{
        chai.request(serverLocalHost)
        .delete('/device')
        .send({
            NAME_COL:DEVICE_NAME
