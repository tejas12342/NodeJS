...
describe('Routes Testing', function(){
    it('Test case1-->Should fetch the records of user with the defined property',function(done){
    ...
    it('should insert the user record successfully with appropriate parameter',function(done){
        chai.request(serverLocalHost)
        .post('/user')
        .send({
            NAME_COL:USER_NAME,
    ...
    it('should not insert the user record successfully with inappropriate parameter',function(done){
        chai.request(serverLocalHost)
        .post('/user')
        .send({
            NAME_COL:USER_NAME
    ...
    it('should update the user record successfully',function(done){
        chai.request(serverLocalHost)
        .put('/user')
        .send({
            NAME_COL:USER_NAME,
    ...
    it('should not update the user record successfully',function(done){
        chai.request(serverLocalHost)
        .put('/user')
        .send({
            NAME_COL:USER_NAME,
    ...
    it('should delete the user record',function(done){
        chai.request(serverLocalHost)
        .delete('/user')
        .send({
            ID:3
    ...
    it('should not delete the user record',function(done){
        chai.request(serverLocalHost)
        .delete('/user')
        .send({
            NAME_COL:USER_NAME
